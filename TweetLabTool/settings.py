...
default_keys = {'SECRET_KEY': '<your key>' }
...
# Files from the STATIC_URL directory within each app are collected
STATIC_URL = '/static/'
if not ON_OPENSHIFT:
    # Add additional directory for static files outside the apps -> for local
    # deployment
    par = os.path.abspath(os.path.join(BASE_DIR, os.pardir))
    STATICFILES_DIRS = (os.path.join(par, "wsgi", "static"),)
